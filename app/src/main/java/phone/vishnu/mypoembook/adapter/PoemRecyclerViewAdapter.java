...
public class PoemRecyclerViewAdapter extends ListAdapter<Poem, PoemRecyclerViewAdapter.PoemHolder> {

    private OnItemClickListener listener;

    public PoemRecyclerViewAdapter() {
